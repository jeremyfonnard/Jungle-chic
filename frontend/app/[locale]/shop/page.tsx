...
export default function ShopPage() {
  ...
  const getCategoryLabel = (cat: string) => {
    const labels: Record<string, Record<string, string>> = {
      all: { fr: 'Tous', en: 'All' },
      'one-piece': { fr: 'Une pièce', en: 'One-piece' },
      bikini: { fr: 'Bikini', en: 'Bikini' },
      tankini: { fr: 'Tankini', en: 'Tankini' },
      'cover-up': { fr: 'Paréos', en: 'Cover-ups' },
    };
    ...
    <React.Fragment>
      ...
      <div className="min-h-screen bg-background">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1693691553855-b691c68d8066?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2Njl8MHwxfHNlYXJjaHwzfHxiZWFjaCUyMHNhbmQlMjB0ZXh0dXJlJTIwcGF0dGVybnxlbnwwfHx8fDE3NjkzNDkzNTl8MA&ixlib=rb-4.1.0&q=85)',
